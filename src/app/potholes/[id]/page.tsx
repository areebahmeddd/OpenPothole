        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                      ...
                      <div key={t.key} className="flex items-center gap-4">
                        <div
                          className={cn(
                            ...
                            current
                              ? "bg-[var(--primary)] ring-4 ring-[var(--primary)]/20 scale-125"
                              : active
                                ? "bg-[var(--primary)]"
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="rounded-2xl border bg-card/50 backdrop-blur-sm p-6 space-y-4">
                <h3 className="text-base font-semibold pb-2 border-b">
                  Community Actions
                </h3>
                <div className="space-y-3">
                  ...
                  >
                    <Button
                      type="submit"
                      className="w-full h-11 bg-[var(--primary)] hover:bg-[var(--primary-dark)] font-semibold"
                    >
                      ✓ Mark as Fixed
                    </Button>
                  </form>
